...
-- FIRST CLASS (1A → 5B = 10 sièges)
INSERT INTO siege (id_avion, numero, classe)
VALUES
...
-- ECONOMY (6A → 35B = 60 sièges)
INSERT INTO siege (id_avion, numero, classe)
SELECT 1, concat(n,'A'), 'ECONOMY' FROM generate_series(6,35) n
UNION ALL
SELECT 1, concat(n,'B'), 'ECONOMY' FROM generate_series(6,35);
